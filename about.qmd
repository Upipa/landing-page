...
layout_column_wrap(
    accordion(
        ...
        accordion_panel(
            "Dott. Emanuele Torri",
            "Direttore Servizio Governance Clinica, Azienda Provinciale per i Servizi Sanitari."
        ),
        accordion_panel(
    ...
    accordion(
        accordion_panel(
            "Dott. Marco Pagani",
            "Medico specializzato in geriatria e gerontologia e in Medicina fisica e riabilitazione, geriatra, responsabile scientifico del servizio."
        ),
        accordion_panel(
